...
Specifically for original SRGAN, the image generated with 1e-4 learning rate is almost unrecognizable, after adjusting the learning rate to 1e-5, the image is much more realistic.
Other solutions to avoid the collapse of the generator are to use pretrain generator for  more epochs.


The pretraining is done for 200 epochs with a learning rate of 0.0001.

The training for GAN is done in 2 stages, first at a learning rate of 0.0001 for 100 epochs, then at a learning rate of 0.00001 for 100 epochs.
